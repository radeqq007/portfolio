...
const ProjectCard = ({
	...
	return (
		<div
			className="border-1 border-accent backdrop-blur-xs w-full md:w-[55vw] min-h-160 py-20 px-8 rounded-xl flex flex-col items-center gap-18 relative"
			data-cursor="expand"
		>
			<img
				src={imgSrc}
				alt={title}
				className="text-text-secondary w-full h-50 object-contain"
			/>
