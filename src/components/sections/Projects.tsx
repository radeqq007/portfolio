		...
		<Section className="col-start-2 row-start-3 relative" title="Projects">
			...
			>
				<ArrowRight
					strokeWidth={1}
					size={22}
					className="-translate-x-2 opacity-0 group-hover/hyperlink:opacity-100 group-hover/hyperlink:translate-x-2"
				/>
				<span className="group-hover/hyperlink:translate-x-2">Explore All</span>
				<ArrowRight
					strokeWidth={1}
					size={22}
